		...
		<center><h2>Owner Profile</h2>
			<table id="myTable">
				...
				<th style="width:30%;"><b>Name</b></th>
					...
					<th style="width:30%;"><b>Date of Birth</b></th>
...
<td><a href="editowner?ssn=${user.getSsn()}"style="text-decoration: none;"><img border="0" alt="Update"
src="https://image.freepik.com/free-icon/pencil-in-a-square-edit-interface-symbol_318-53384.jpg"
				width="25" height="25"> <a
href="deleteowner?ssn=${user.getSsn()}"	onclick="return confirm('Are you sure you want to delete this profile');" style="text-decoration: none;"><img border="0" alt="Delete"
