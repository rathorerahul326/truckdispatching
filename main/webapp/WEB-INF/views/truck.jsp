	...
	<form action="truckregistration" method="post">
		<table align="center" width="40%" width="100%" cellspacing="0"
			...
			<tr>
				...
				<td width="30%"><input type="text" name="trucknumber" required></td>
			</tr>
			...
			<tr>
				<td align="left" valign="top" width="30%"><h4
						style="color: white;">Current Estimated Mileage*</h4></td>
				<td width="30%"><input type="number" name="mileage" required></td>
			</tr>
<tr>
				<td align="left" valign="top" width="30%"><h4
						style="color: white;">Max Load*</h4></td>
				<td><input type="number" name="maxload" required></td>
			</tr>
			...
			<tr>
				<td align="left" valign="top" width="30%"><h4
						style="color: white;">Truck Registration Expiration Date*</h4></td>
			...
			<tr>
				<td align="center" colspan="2" ><input type="submit"
					value="Add Truck" onclick="return confirm('Are you sure you want to add this detail');"></td>
			</tr>
		</table>
	</form>
</body>
