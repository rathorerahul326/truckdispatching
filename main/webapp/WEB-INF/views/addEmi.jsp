...
<body bgcolor="#999999">
	...
	<div class="w3-container">
		...
		<form action="addinstallment" method="post">
			<table align="center" width="40%" width="100%" cellspacing="0"
				...
				<tr>
					...
					<td width="30%"><b>${remaingross}</b>  <input type="hidden"
						name="grossaftercommission" value="${remaingross}" />   </td>
				...
				<tr>
					...
					<td width="30%"><input type="text" name="advance" required></td>
				</tr>
  ...
  <option value="MAINTENACE">Maintenance</option> 
				...
				<tr>
					<td align="center" colspan="2"><input type="submit"
						value="Add Advance"onclick="return confirm('Are you sure you want to make this Payment');"></td>
				</tr>
			</table>
		</form>
</body>
