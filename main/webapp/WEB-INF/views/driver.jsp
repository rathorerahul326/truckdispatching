		...
		<form action="driverregister" method="post">
			<table align="center" width="40%" width="100%" cellspacing="0"
				...
				<tr>
					...
					<td width="30%"><input type="date" name="dob" required></td>
				</tr>
				...
				<tr>
					...
					<td><input type="date" name="licence_expiration" required></td>
				</tr>

				<tr>
					<td align="left" valign="top" width="30%"><h4
							style="color: white;">Driver Medical Card Expiration*</h4></td>
					<td><input type="date" name="medical_expiration" required></td>
				</tr>
				...
				<tr>
					...
					<td><input type="date" name="testexpiry" required></td>
				</tr>
				<tr>
					<td align="left" valign="top" width="30%"><h4
					...
					<td><select name="assignedtruck">

							<c:forEach var="user1" items="${list1}">
								<option value="${user1.getTrucknumber()}">${user1.getTrucknumber()}
								</option>
				...
				<tr>
					...
					<td><select name="truckowner">
							...
							<c:forEach var="user" items="${list}">
								<option value="${user.getSsn()}">${user.getName()}
									${user.getSsn()}</option>
				...
				<tr>
					<td align="center" colspan="2"><input type="submit"
						value="Add Driver" onclick="return confirm('Are you sure you want to add this detail');"></td>
				</tr>
			</table>
		</form>
</body>
