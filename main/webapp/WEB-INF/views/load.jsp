	...
	<form action="addload" method="post">
		<table align="center" width="40%" width="100%" cellspacing="0"
			...
			<tr>
				...
				<td width="30%"><input type="text" name="loadNumber" required></td>
			</tr>
			...
			<tr>
				...
				<td width="30%"><input type="text" name="gross" required id="gross1" onchange="myFunction1()"></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="dispatureCommission" id="dpc"  readonly> <input type="hidden" name="totalamountpaid" value="0"></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="grossafterCommision" id="acg"  readonly></td>
			</tr>
				<tr>
				<td align="left" valign="top" width="30%"><h4
						style="color: white;">Pickup date Date*</h4></td>
				<td width="30%"><input type="date" name="pickupDate" required ></td>
			</tr>
				...
				<td><input type="text" name="pickupCity" required></td>
			</tr>
				...
				<td><input type="text" name="pickupState" required></td>
			</tr>
			
				<tr>
				<td align="left" valign="top" width="30%"><h4
						style="color: white;">Drop OFF Date*</h4></td>
				<td width="30%"><input type="date" name="dropoffDate" required ></td>
			</tr>
				...
				<td><input type="text" name="dropCity" required></td>
			</tr>
				...
				<td><input type="text" name="dropState" required></td>
			</tr>
  ...
  <option value="0">Close</option>
			...
			<tr>
				<td align="center" colspan="2" ><input type="submit"
					value="Add Load" onclick="return confirm('Are you sure you want to add this detail');"></td>
			</tr>
		</table>
	</form>
